#ifndef SMBIOS_type_structs_H
#define SMBIOS_type_structs_H

#include <ntifs.h>
#include <ntddk.h>

// 코드 출처: https://github.com/tianocore/edk2/blob/master/MdePkg/Include/IndustryStandard/SmBios.h#L195
...
///
typedef struct {
    SMBIOS_STRUCTURE            Hdr; // 기본이 되는 SMBIOS 구조체 
    SMBIOS_TABLE_STRING         Manufacturer;
    SMBIOS_TABLE_STRING         ProductName;
    SMBIOS_TABLE_STRING         Version;
    SMBIOS_TABLE_STRING         SerialNumber;
