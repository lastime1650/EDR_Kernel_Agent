> [!CAUTION]
> 이 레포지토리는 오래되었습니다.
> 이보다 개선된 Kernel based Agent 는 [이 레포지토리](https://github.com/lastime1650/VATEX_EVIDENTIA_EDR)에 있습니다.
> 
> 단, 설치 환경 및 운영이 단일 커널 에이전트 방식에서의 추가적 수집 안정성을 위하여 이제는 **유저모드<->커널간 협력**을 유지하는 방식으로 변경되며,
> 
> ETW기반의 수집 추가 기능이 확대되었습니다.
